...
public class AlivcWheelDialogFragment extends BaseDialogFragment implements WheelView.OnValueChangeListener {
    ...
    public interface OnWheelDialogListener {
         ...
         * @param value
         */
        void onClickLeft(AlivcWheelDialogFragment dialog, String value);
         ...
         * @param value
         */
        void onClickRight(AlivcWheelDialogFragment dialog, String value);
         ...
         * @param value
         */
        void onValueChanged(AlivcWheelDialogFragment dialog, String value);
    }
