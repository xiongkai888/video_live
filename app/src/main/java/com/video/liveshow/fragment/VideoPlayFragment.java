...
import com.video.liveshow.adapter.VideoPlayAdapter;
import com.video.liveshow.bean.VideoBean;
import com.video.liveshow.custom.LoadingBar;
import com.video.liveshow.custom.VerticalViewPager;
import com.video.liveshow.custom.VideoPlayView;
...
import com.video.liveshow.interfaces.VideoChangeListener;
            ...
            if (code == 0 && info.length > 0) {
                ...
                if (list.size() > 0) {
                    if (mAdapter == null) {
                        ...
                        initAdapter(list);
                        mViewPager.setCurrentItem(list.size() - 3);
                    }
                }
    ...
    private VideoPlayView.PlayEventListener mPlayEventListener = new VideoPlayView.PlayEventListener() {
        ...
        public void onFirstFrame() {
            ...
            if (!mStartWatch) {
                ...
                if (videoBean != null && AppConfig.getInstance().isLogin()) {
