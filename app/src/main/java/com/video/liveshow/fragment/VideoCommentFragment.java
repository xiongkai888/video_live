...
import com.video.liveshow.activity.AtFriendsActivity;
import com.video.liveshow.activity.ReplyActivity;
...
import com.video.liveshow.custom.AtEditText;
...
import com.video.liveshow.event.ReplyCommentEvent;
import com.video.liveshow.event.ReplyCommentLikeEvent;
...
public class VideoCommentFragment extends DialogFragment implements View.OnClickListener, CommentAdapter.ActionListener {
    ...
    private CommentAdapter.ActionListener actionListener;

    public void setActionListener(CommentAdapter.ActionListener actionListener) {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mRefreshView.setDataHelper(new RefreshView.DataHelper<CommentBean>() {
            ...
            public List<CommentBean> processData(String[] info) {
                ...
                return JSON.parseArray(obj.getString("commentlist"), CommentBean.class);
            }
...
//                break;
    ...
    public void onOtherUser(UserBean bean, int isAttention) {
        if (actionListener != null) {
            actionListener.onOtherUser(bean, isAttention);
            dismiss();
        }
    }
