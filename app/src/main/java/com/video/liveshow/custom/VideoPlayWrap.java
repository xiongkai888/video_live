...
import com.video.liveshow.bean.MusicBean;
...
public class VideoPlayWrap extends FrameLayout implements View.OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mVideoAd = (LinearLayout) view.findViewById(R.id.videoad);
        ...
        mVideoAd.setOnClickListener(this);
    ...
    public void loadData(VideoBean bean) {
        ...
        //广告
        if (bean.getIsad().equals("1")) {
            mVideoAd.setVisibility(VISIBLE);
        } else {
            mVideoAd.setVisibility(INVISIBLE);
        }
...
//        }
    ...
    public void addPlayView(VideoPlayView playView) {
        ...
        mPlayView.setOnDoubleTapEventListener(new VideoPlayView.OnDoubleTapEventListener() {
            @Override
            public void onDoubleTapEvent() {
                String videoId = getVideoBean().getId();
                    ...
                    HttpUtil.setVideoLike(videoId, new HttpCallback() {
                        ...
                        public void onSuccess(int code, String msg, String[] info) {
                            if (code == 0 && info.length > 0) {
                                ...
                                setLikes(islike, obj.getString("likes"));
        ...
        if (mActionListener != null && mVideoBean != null) {
            switch (v.getId()) {
                ...
                case R.id.btn_follow:
                    ...
                    break;
                case R.id.videoad:
                    mActionListener.onClickAd(this, mVideoBean);
                    break;
                case R.id.avatar:
    ...
    public VideoBean getVideoBean() {
        return mVideoBean == null?new VideoBean():mVideoBean;
    }
    ...
    public interface ActionListener {
        ...
        void onClickAd(VideoPlayWrap wrap, VideoBean bean);
    }
