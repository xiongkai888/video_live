...
public class VideoPlayView extends FrameLayout implements GestureDetector.OnGestureListener {
    ...
    public OnDoubleTapEventListener listener;

    public interface OnDoubleTapEventListener{
        void onDoubleTapEvent();
    }

    public void setOnDoubleTapEventListener(OnDoubleTapEventListener listener){
