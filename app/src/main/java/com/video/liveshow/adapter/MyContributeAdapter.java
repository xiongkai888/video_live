...
public class MyContributeAdapter extends RefreshAdapter<ContributeBean> {

    public MyContributeAdapter(Context context) {
        super(context);
    }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(ContributeBean bean, int position, Object payload) {
            mLevel.setText(bean.name);
            mRequest.setText(bean.cdate);
            mOrder.setText("+" + bean.num);
        }
    }
