...
import com.video.liveshow.custom.RangeSlider;
import com.video.liveshow.cut.Mp3Cutter;
...
import com.video.liveshow.upload.VideoTxUpload;
...
public class EditMusicActivity extends AudioAbsActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        mCutDialog = DialogUitl.loadingDialog(mContext, "剪辑中");
        mCutDialog.show();
        if (mMp3Cutter == null) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (cutResult.exists() && cutResult.length() > 0) {
                                DialogUitl.showSimpleDialog(mContext, "", "确定将剪辑的音乐上传至音乐库？", new DialogUitl.SimpleDialogCallback() {
                                    @Override
    ...
    private void uploadMusic() {
        mUploadDialog = DialogUitl.loadingDialog(mContext, "上传中");
        mUploadDialog.show();
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    if (configBean != null) {
                        ...
                        HttpUtil.getConfig(EditMusicActivity.this,new CommonCallback<ConfigBean>() {
                            @Override
