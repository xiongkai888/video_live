...
public class CommentAdapter extends RefreshAdapter<CommentBean> {
        ...
        public Vh(View itemView) {
            ...
            mAvatar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!mBean.getUid().equals(AppConfig.getInstance().getUid())){
                        mActionListener.onOtherUser(mBean.getUserinfo(),0);
                    }
    ...
    public interface ActionListener {
        ...
        void onOtherUser(UserBean bean ,int isAttention);//评论列表点击用户头像进入用户界面
    }
