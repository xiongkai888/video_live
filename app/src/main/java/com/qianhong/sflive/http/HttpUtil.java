package com.qianhong.sflive.http;
...
import com.qianhong.sflive.activity.SettingActivity;
import com.qianhong.sflive.bean.ConfigBean;
import com.qianhong.sflive.bean.TxLocationBean;
import com.qianhong.sflive.bean.TxLocationPoiBean;
import com.qianhong.sflive.event.FollowEvent;
import com.qianhong.sflive.event.NeedRefreshEvent;
...
public class HttpUtil {
     ...
     * 启动页信息
     */
    public static void ADMsg(CheckTokenCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Home.GetBootAd")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .tag(IF_TOKEN)
     ...
     * 获取config
     */
    public static void getConfig(final Context mContext, final CommonCallback<ConfigBean> commonCallback) {
    ...
    private static void setUpdate(final Context mContext, ConfigBean bean) {

        try {
            int code = Integer.parseInt(bean.getApk_ver());
            if (code > AppConfig.getInstance().getCode()) {
                DialogUitl.showSimpleDialog(mContext, "版本更新", bean.getApk_des(), new DialogUitl.SimpleDialogCallback() {
                    @Override
                ...
                ToastUtil.show(WordUtil.getString(R.string.latest_version));//是在设置界面里面就执行这句
            }

        } catch (Exception e) {
//            ToastUtil.show("tttttttttt");
            Log.d("tagg","版本号解析错误");
        }
     ...
     * @param callback
     */
    public static void login(String phoneNum, String pwd, String device, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Login.userLogin")
                .headers("Connection", CONNECTION)
                .params("user_login", phoneNum)
                .params("password", pwd)
    ...
    public static void findPWD(String phoneNum, String pwd, String pwd2, String code, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Login.UserFindPass")
                .headers("Connection", CONNECTION)
                .params("user_login", phoneNum)
                .params("user_pass", pwd)
                .params("user_pass2", pwd2)
                .params("code", code)
                .tag(LOGIN)
                .execute(callback);
    }
    ...
    public static void getTradeCenterInfo(String tag, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Trade.GetTradeInfo")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .tag(tag)
    ...
    public static void storeTradeTodayInfo(String tag, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Trade.StoreCandy")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .tag(tag)
    ...
    public static void getTradeMissionMine(String tag, int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Task.GetMyTask")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getTradeMission(String tag, int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Task.GetTask")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getTradeMissionHistory(String tag, int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Task.GetMyTaskLog")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void receiveTradeMissionTask(String tag, String tid, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=User.ReceiveTask")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("tid", tid)
    ...
    public static void getTradeList(String tag, String sid, int p, int keywords, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Trade.GetTradeList")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("sid", sid)
    ...
    public static void sendTrade(String tag, int type, String price, String number, String total, String password, String account, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Trade.OrderCandy")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("type", type)
                ...
                .params("payacount", account)
                .tag(tag)
                .execute(callback);
    }

    public static void saleTrade(String tag, String id, String number, String password, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Trade.Sell")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("number", number)
    ...
    public static void saleTradeList(String tag, int p, String type, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Trade.GetOrderList")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
     ...
     * @param tag
     * @param id
     * @param type     confirm确认订单/appeal申诉
     * @param callback
     */
    public static void confirmTradeBuy(String tag, String id, String type, File file, String password, HttpCallback callback) {
        OkGo.<JsonBean>post(HTTP_URL + "service=Trade.BuyConfirmOrder")
                .headers("Connection", CONNECTION)
                .isMultipart(true)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
    ...
    public static void cancelTradeBuy(String tag, String id, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=trade.RevokeOrder")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("id", id)
     ...
     * @param callback
     */
    public static void confirmTradeSale(String tag, String id, String password, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Trade.SellConfirmOrder")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("id", id)
    ...
    public static void getLevelList(int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=user.getUserLevel")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getStarList(int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=user.getUserStar")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getRankList(int p, String type, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=user.GetRank")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getContributeList(int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=User.GetUserAc")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getMyCandyList(int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=User.GetUserCandyLog")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void setSecondPwd(String phoneNum, String code, String signature, String password, String name, String type, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=User.SetUserPayPassword")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("user_login", phoneNum)
    ...
    public static void getMyMoney(int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=User.MyCandy")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getMyFriends(int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=User.GetLowerLevel")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .params("p", p)
    ...
    public static void getMyOrder(HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Charge.getrealorder")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .tag(GET_BLACK_LIST)
    ...
    public static void getMyAuth(String mobile, String id_card_number, String name, HttpCallback callback) {
        OkGo.<JsonBean>post(AppConfig.HOST + "/index.php?g=Api&m=Discern&a=getPerson")
                .headers("Connection", CONNECTION)
                .isMultipart(true)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
