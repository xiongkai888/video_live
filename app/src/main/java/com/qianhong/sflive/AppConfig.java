...
public class AppConfig {
    ...
    //域名
    //    public static final String HOST = "http://video.api.shuchengrj.com";
    ...
    public static final String FILE_PROVIDER = "com.qianhong.sflive.fileprovider";
    ...
    public ConfigBean getConfig() {
        return mConfig == null ? new ConfigBean() : mConfig;
    }
