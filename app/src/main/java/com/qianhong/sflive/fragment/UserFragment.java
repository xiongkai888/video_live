...
import com.qianhong.sflive.activity.ChatActivity;
import com.qianhong.sflive.activity.EditProfileActivity;
import com.qianhong.sflive.activity.FansActivity;
import com.qianhong.sflive.activity.FollowActivity;
import com.qianhong.sflive.activity.LoginActivity;
import com.qianhong.sflive.activity.OtherUserActivity;
import com.qianhong.sflive.activity.SettingActivity;
import com.qianhong.sflive.activity.ShareActivity;
import com.qianhong.sflive.activity.VideoPlayActivity;
import com.qianhong.sflive.activity.WalletActivity;
import com.qianhong.sflive.activity.WebUploadImgActivity;
import com.qianhong.sflive.activity.ZSFMessageActivity;
import com.qianhong.sflive.activity.ZanMoneyActivity;
...
import com.qianhong.sflive.event.LoginUserChangedEvent;
...
import com.qianhong.sflive.interfaces.AppBarStateListener;
...
public class UserFragment extends AbsFragment implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void main() {
        ...
        if (mIsMainUserCenter) {
            ...
            mRootView.findViewById(R.id.btn_self_msg).setOnClickListener(this);
...
//            btnShare.setVisibility(View.VISIBLE);
            ...
            HttpUtil.getConfig(mContext,new CommonCallback<ConfigBean>() {
                ...
                public void callback(ConfigBean configBean) {
                    shareCoinVal.setText("邀请注册送" + configBean.getInvite_tacket() + "QKL股份");
    ...
    private void forwardMsg() {
        startActivity(new Intent(mContext, ZSFMessageActivity.class));
    }
...
//        startActivity(new Intent(mContext, ZSFRecordDetailActivity.class));
    }
